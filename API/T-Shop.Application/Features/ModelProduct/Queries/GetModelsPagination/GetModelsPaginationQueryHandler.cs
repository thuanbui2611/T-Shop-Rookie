...
public class GetModelsPaginationQueryHandler : IRequestHandler<GetModelsPaginationQuery, (List<ModelProductResponseModel>, PaginationMetaData)>
{
    private readonly IMapper _mapper;
    private readonly IModelQueries _modelQueries;
    private readonly IAppCache _cache;
    private CacheKeyConstants _cacheKeyConstants;
    public GetModelsPaginationQueryHandler(IMapper mapper, IModelQueries modelQueries, IAppCache cache, CacheKeyConstants cacheKeyConstants)
    {
        _mapper = mapper;
    ...
    public async Task<(List<ModelProductResponseModel>, PaginationMetaData)> Handle(GetModelsPaginationQuery request, CancellationToken cancellationToken)
    {
