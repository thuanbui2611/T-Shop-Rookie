...
public class GetBrandsQueryHandler : IRequestHandler<GetBrandsQuery, (List<BrandResponseModel>, PaginationMetaData)>
{
    ...
    public async Task<(List<BrandResponseModel>, PaginationMetaData)> Handle(GetBrandsQuery request, CancellationToken cancellationToken)
    {
